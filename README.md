...
Клонируйте репозиторий `aidogs-reserve` на ваш локальный компьютер:

```bash
git clone https://github.com/cyberomanov/aidogs-reserve.git && \
cd aidogs-reserve
```
...
```bash
tmux new -s aidogs-reserve; tmux attach -t aidogs-reserve
```
